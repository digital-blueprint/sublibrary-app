...
export class LibraryUserSelect extends LangMixin(
    ScopedElementsMixin(AdapterLitElement),
    createInstance,
) {
    constructor() {
        super();
        Object.assign(LibraryUserSelect.prototype, errorUtils.errorMixin);
        this.auth = {};
        ...
        this.selectId = 'user-select-' + commonUtils.makeId(24);
        this.value = '';
        this.object = null;
    ...
    initSelect2(ignorePreset = false) {
        ...
        const apiUrl = combineURLs(this.entryPointUrl, '/sublibrary/users');
        ...
        this.$select
            .select2({
                ...
                placeholder: this.authenticated()
                    ? i18n.t('library-user-select.placeholder')
                    : i18n.t('library-user-select.login-required'),
                dropdownParent: this.$('#user-select-dropdown'),
                ajax: {
                    delay: 500,
                    url: apiUrl,
                    ...
                    processResults: function (data) {
                        that.$('#user-select-dropdown').addClass('select2-bug');
            ...
            .on('select2:select', function (e) {
                that.$('#user-select-dropdown').removeClass('select2-bug');
    ...
    getFilterQueryParameters(select, searchTerm) {
        return LibraryUserSelect.getFilterQueryParametersDefault(select, searchTerm);
    }
    ...
    render() {
        ...
        return html`
            ...
            <div class="select">
                ...
                <div id="user-select-dropdown"></div>
            </div>
        `;
    }
}
